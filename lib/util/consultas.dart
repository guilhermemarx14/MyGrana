...
var kInsertUniversidades = [
  ...
  "(146, 'Estadual do Ceará (UECE)', 6);",
  "(147, 'Faculdade Católica Rainha do Sertão (FCRS)', 6);",
  "(148, 'Faculdade Católica de Fortaleza (FCF)', 6);",
  "(149, 'Faculdade Católica do Cariri', 6);",
  "(150, 'Faculdade Católica do Ceará (FCC)', 6);",
  "(151, 'Faculdade Cearense (FAC)', 6);",
  "(152, 'Faculdade Christus (CHRISTUS)', 6);",
  "(153, 'Faculdade Evolutivo (FACE)', 6);",
  "(154, 'Faculdade Farias Brito (FFB)', 6);",
  "(155, 'Faculdade Integrada da Grande Fortaleza (FGF)', 6);",
  "(156, 'Faculdade Latino Americana de Educação (FLATED)', 6);",
  "(157, 'Faculdade Luciano Feijão (FLF)', 6);",
  "(158, 'Faculdade Metropolitana da Grande Fortaleza (FAMETRO)', 6);",
  "(159, 'Faculdade Nordeste (FANOR)', 6);",
  "(160, 'Faculdade Oboé (FACO)', 6);",
  "(161, 'Faculdade Paraíso do Ceará (FAP)', 6);",
  "(162, 'Faculdade Princesa do Oeste (FPO)', 6);",
  "(163, 'Faculdade Sete de Setembro (FA7)', 6);",
  "(164, 'Faculdade Teológica e Filosófica (RATIO)', 6);",
  "(165, 'Faculdade Terra Nordeste (FATENE)', 6);",
  "(166, 'Faculdade Vale do Salgado (FVS)', 6);",
  "(167, 'Faculdade de Ciências Aplicadas Doutor Leão Sampalio (FLS)', 6);",
  "(168, 'Faculdade de Ciências Humanas de Fortaleza (FCHFOR)', 6);",
  "(169, 'Faculdade de Ensino e Cultura do Ceará (FAECE)', 6);",
  "(170, 'Faculdade de Juazeiro do Norte (FJN)', 6);",
  "(171, 'Faculdade de Tecnologia CDL de Fortaleza', 6);",
  "(172, 'Faculdade de Tecnologia Cariri (CENTEC)', 6);",
  "(173, 'Faculdade de Tecnologia Darcy Ribeiro (FTDR)', 6);",
  "(174, 'Faculdade de Tecnologia Evolução (FECET)', 6);",
  "(175, 'Faculdade de Tecnologia Informática (FATI)', 6);",
  "(176, 'Faculdade de Tecnologia Intensiva (FATECI)', 6);",
  "(177, 'Faculdade de Tecnologia do Nordeste (FATENE)', 6);",
  "(178, 'Faculdade do Vale do Jaguaribe (FVJ)', 6);",
  "(179, 'Instituto Federal do Ceará (IFCE)', 6);",
  "(180, 'Instituto Superior de Teologia Aplicada (INTA)', 6);",
  "(181, 'Instituto de Ensino Superior de Fortaleza (IESF)', 6);",
  "(182, 'Universidade Estadual do Vale do Acaraú (UVA)', 6);",
  "(183, 'Universidade Federal de Integração Luso-Afro-Brasileira (UNILAB)', 6);",
  "(184, 'Universidade Federal de Integração Luso-Afro-Brasileira (UNILAB)', 6);",
  "(185, 'Universidade Federal do Ceará (UFC)', 6);",
  "(186, 'Universidade Regional do Cariri (URCA)', 6);",
  "(187, 'Universidade de Fortaleza (UNIFOR)', 6);"
];
