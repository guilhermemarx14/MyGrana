...
const String kInsertEstados = "INSERT INTO `estado` (`id`, `nome`, `uf`) VALUES"
    "(1, 'Acre', 'AC'),"
    "(2, 'Alagoas', 'AL'),"
    "(3, 'Amazonas', 'AM'),"
    "(4, 'Amapá', 'AP'),"
...
const String kCreateTableCidades =
    "CREATE TABLE IF NOT EXISTS `cidade` (`id` int(11),`nome` varchar(120),`estado` int(5),PRIMARY KEY (`id`),KEY `fk_Cidade_estado` (`estado`));";
